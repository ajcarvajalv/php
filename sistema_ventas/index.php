                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$ <?php echo number_format($facturacionMensual, 0, ",","." ) ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$ <?php echo number_format($facturacionAnual, 0, ",","." ) ?></div></div>
                    </div>
                    <div class="col-auto">
